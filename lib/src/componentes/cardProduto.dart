...
class _CardProdutoState extends State<CardProduto> {
  ...
  _listarDados() async{
    ...
    var response = await http.get(
        Uri.encodeFull(
          "produtos/listar.php?nome=${buscar}&idcat=${widget._idcat}"),
  ...
  mensagem(){
    ...
    //showDialog(context: context, child: alert);mudar isso
              ...
              itemBuilder: (context, i){
                ...
                return new Container(
                  ...
                  child:Stack(
                    children: <Widget>[
                      Container(
                        child:Image.network(conf_site + "/images/produtos/" + item['imagem']),
